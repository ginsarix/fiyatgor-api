...
import { diaSessionExpiration, sessionExpiration, } from "../constants/redis/expirations.js";
import { diaSessionKey, sessionKey, userSessionKey, } from "../constants/redis/keys.js";
import { redis } from "../redis/index.js";
export async function setDiaSession(firmId, sessionId) {
    return await redis.set(`${diaSessionKey}:${firmId}`, sessionId, {
        expiration: { type: "EX", value: diaSessionExpiration },
    });
}
export async function getDiaSession(firmId) {
 ...
 * @returns the
 */
export async function setSession(userId, serverCode, role, name) {
